const icons = {
    Perfume: (size, className = '') => `<svg class="icon ${className}" width="${size}" height="${size}" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Perfume logo">
        ...
        <polygon points="60,4 100,22 116,60 100,98 60,116 20,98 4,60 20,22"
            fill="none" stroke="currentColor" stroke-width="1.8" opacity="0.35"/>
        <!-- Círculo interior -->
        ...
        <!-- Puntos decorativos -->
        <circle cx="60" cy="14" r="2.5" fill="currentColor" opacity="0.6"/>
        <circle cx="60" cy="106" r="2.5" fill="currentColor" opacity="0.6"/>
    </svg>`,
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="space-y-8">
                    <div class="glass-dark p-4 rounded-3xl border border-amber-400/30 shadow-2xl">
                        <video src="video.mp4" autoplay loop muted playsinline class="w-full h-full object-cover rounded-2xl shadow-2xl border border-amber-400/20"></video>
                    </div>
